# Contributing to update-workspace-root-version
...
1. [Create a tag](https://github.com/ijlee2/update-workspace-root-version/releases/new) and provide release notes. The tag name should match the package version (e.g. `0.1.2`).
